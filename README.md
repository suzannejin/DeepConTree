...
## Output structure
All the files generated by the pipeline will be stored in the `-out_dir` specified by user. An example of the output directory structure is:
...
out_dir/
     ...
     |       |--deepconpred/
     |       |          |--PROT.con
     |       |          |--PROT_deepconpred_features/
     |       |          |--(input feature files. Eg PROT.spd33, PROT.hhm, etc)
     |       |
     |       |--deepcontact/
     |       |          |--PROT.con
     |       |          |--PROT_deepcontact_features/
     |       |          |--(input feature files.)
     |       |           
     |       |--deepcov/
     |       |        |--PROT.con
     ...
     |       |
     |       |--aln/
     |       |    |--(alignment for DeepCov and DeepConPred)
     |       |
     |       |--con_list
     |
     |--simulations/
     |       |--deepconpred_score0-5_seqsep8/
     |       |                            |--n1/  (nºexperiment)
     |       |                                |--PROT.pdb (average structure)
     |       |                                |--PROT_models/
     |       |                                            |--PROT.con (filtered contact file)
     |       |                                            |--(restraint.tbl files)
     |       |                                            |--(decoy models + violation files)
     |     [...]
     |       
     |--trees/
     |      |--deepconpred_score0-5_seqsep8_n1/
     |      |                               |--PROT.pdb
     |      |                               |--out/
     |      |                                    |--aln/  
     |      |                                    |    |--(tmalign alignment)
     |      |                                    | 
     |      |                                    |--tree1d/ 
     |      |                                    |       |--(sequence based tree.nwk)
     |      |                                    | 
     |      |                                    | --tree3d/
     |      |                                            |--(structure based tree.nwk)
     |      |                                            |--NAME/
     |      |                                                  |--(matrices, tree replicates, etc)
     |    [...]
     |      |
     |      |--rf.txt (text file with the normalized RF score estimated by comparing each tree to the tree based on experimental structures.)
     |      |--rf.xlsx (excel file with the matrix of the pairwise normalized RF score)
     |
     |--pdb/
     |    |--PROT.pdb (experimental PDB files given by user)
     |
     |--pdb_matched/
     |            |--PROT.pdb (experimental PDB files with the positions of residues and atoms starting from 1)
     |
     |--seq/
     |    |--PROT.fa (fasta files extracted from the multifasta file)
     |
     |--sse/
          |--PROT.sse (SSE predictions)
